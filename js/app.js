...
const HERBS = [
  ...
  {id:3,n:"Maracujá",lat:"Passiflora edulis",icon:"🍃",img:"images/produtos/maracuja.png",tagline:"Ansiolítico natural e relaxante muscular",cat:"Calmante",ef:"Ansiolítico natural, relaxante, sono",detail:"Comparado a benzodiazepínicos suaves em estudos clínicos. Ideal para ansiedade com componente físico (taquicardia, tensão muscular). Seguro para uso diário.",safe:["hipertensos"],avoid:["gestantes (doses altas)"],temp:"85°C",tempo:"8 min",dose:"1-2 col. sopa / 250ml",freq:"2x ao dia + noite",tags:["ansiedade","sono","calmante","taquicardia"],momento:["noite","tarde"]},
