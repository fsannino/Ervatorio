...
const HERBS = [
  ...
  {id:29,n:"Aroeira-da-Praia",lat:"Schinus terebinthifolius Raddi",icon:"🌿",cat:"Anti-inflamatório",linha:"Funcional",tagline:"Pimenta-rosa brasileira virou cicatrizante ginecológico oficial.",ef:"Anti-inflamatório tópico — monografado, Cicatrizante ginecológico, Adstringente potente",detail:"Planta caiçara com dupla identidade: tempero gourmet (pimenta-rosa) e fitoterápico monografado. Casca em decocção para uso externo ginecológico — anti-inflamatório e cicatrizante via taninos concentrados.",safe:["adultos saudáveis","hipertensos"],avoid:[],temp:"100°C",tempo:"10 min",dose:"1 g de cascas secas / 150 ml (uso externo)",freq:"banho de assento 3-4x ao dia",tags:["inflamacao","pele","ginecologico","oral"],momento:["qualquer"]},
  {id:30,n:"Assa-Peixe",lat:"Vernonia polyanthes Less",icon:"🌿",cat:"Respiratório",linha:"Essencial",tagline:"Arbusto de pastagens brasileiras — expectorante oficial da Anvisa.",ef:"Expectorante — monografado, Anti-inflamatório, Broncodilatador leve",detail:"Arbusto pioneiro de pastagens brasileiras. Expectorante monografado pela Anvisa — saponinas estimulam secreção brônquica. Flor importante para apicultura nacional.",safe:["adultos saudáveis","hipertensos"],avoid:["gestantes","lactantes"],temp:"95°C",tempo:"10 min",dose:"3 g de folhas secas / 150 ml",freq:"1x ao dia em quadros agudos",tags:["respiratorio"],momento:["qualquer"]},
  {id:31,n:"Barbatimão",lat:"Stryphnodendron adstringens (Mart.) Coville",icon:"🌿",cat:"Pele",linha:"Funcional",tagline:"Árvore do cerrado com casca cicatrizante oficial da Anvisa.",ef:"Cicatrizante — monografado, Adstringente potente, Anti-inflamatório tópico",detail:"Árvore do cerrado com a maior concentração de taninos condensados entre as ervas oficiais brasileiras. Creme cicatrizante monografado — taninos formam película proteica sobre feridas. Uso externo.",safe:["adultos saudáveis","hipertensos"],avoid:[],temp:"95°C",tempo:"10 min",dose:"Creme: aplicação tópica conforme bula",freq:"2-3x ao dia",tags:["inflamacao","pele","ginecologico","oral"],momento:["qualquer"]},
  {id:32,n:"Boldo-Baiano",lat:"Vernonia condensata Baker",icon:"🌿",cat:"Digestivo",linha:"Essencial",tagline:"O terceiro boldo brasileiro — folha amarga do quintal nordestino.",ef:"Antidispéptico, Hepatoativo leve, Anti-inflamatório leve",detail:"Terceira planta brasileira chamada 'boldo' — folha amarga com sesquiterpenos lactonas. Antidispéptico monografado. Tradição afro-brasileira no Nordeste.",safe:["adultos saudáveis","hipertensos"],avoid:[],temp:"95°C",tempo:"10 min",dose:"conforme monografia oficial",freq:"após refeições",tags:["digestao"],momento:["qualquer"]},
  {id:33,n:"Boldo-Brasileiro",lat:"Plectranthus barbatus Andrews",icon:"🌿",cat:"Digestivo",linha:"Essencial",tagline:"O boldo do quintal brasileiro — planta africana naturalizada, gentil.",ef:"Antidispéptico — monografado, Colagogo leve, Hepatoativo suave",detail:"Planta africana (Plectranthus barbatus) naturalizada nos quintais brasileiros. Antidispéptico monografado, mais gentil que o boldo-do-chile. Forskolina é seu diterpeno característico.",safe:["adultos saudáveis"],avoid:["gestantes","lactantes","crianças","hipertensos"],temp:"95°C",tempo:"5 min",dose:"1 a 3 g de folhas / 150 ml (1 a 3 folhas frescas)",freq:"2-3x ao dia após refeições pesadas",tags:["digestao","hepatico"],momento:["qualquer"]},
  {id:34,n:"Chambá",lat:"Justicia pectoralis Jacq.",icon:"🌿",cat:"Respiratório",linha:"Essencial",tagline:"Erva do Nordeste com aroma de baunilha e ação expectorante oficial.",ef:"Expectorante — monografado, Broncodilatador leve, Antitussígeno suave",detail:"Erva do Ceará com aroma de baunilha (cumarina). Expectorante monografado, permitido a partir dos 3 anos. Base do programa Farmácias Vivas da UFC.",safe:["adultos saudáveis","hipertensos"],avoid:["anticoagulantes"],temp:"95°C",tempo:"10 min",dose:"5 g de partes aéreas / 150 ml",freq:"2-3x ao dia em quadros de tosse",tags:["respiratorio","inflamacao"],momento:["qualquer"]},
  {id:35,n:"Chapéu-de-Couro",lat:"Echinodorus macrophyllus (Kunth) Micheli",icon:"🌿",cat:"Urinário",linha:"Funcional",tagline:"Folha larga de brejo brasileiro — diurético e anti-inflamatório oficial.",ef:"Diurético leve — monografado, Anti-inflamatório — monografado, Antidispéptico",detail:"Folha larga de brejos brasileiros. Diurético e anti-inflamatório monografado — diterpenos clerodanos. Uso tradicional em litíase urinária e gota.",safe:["adultos saudáveis"],avoid:["gestantes","lactantes","hipertensos"],temp:"95°C",tempo:"10 min",dose:"1 g de folhas / 150 ml",freq:"3x ao dia antes das refeições",tags:["urinario"],momento:["qualquer"]},
  {id:36,n:"Copaíba",lat:"Copaifera spp. (C. langsdorffii · C. multijuga · C. reticulata)",icon:"🌿",cat:"Anti-inflamatório",linha:"Funcional",tagline:"Óleo-resina do coração da Amazônia — anti-inflamatório tópico poderoso.",ef:"Anti-inflamatório tópico — monografado, Cicatrizante, Antimicrobiano",detail:"Óleo-resina extraído do tronco de árvores amazônicas centenárias. Pomada anti-inflamatória monografada — beta-cariofileno age no receptor canabinoide CB2. Três espécies oficiais.",safe:["adultos saudáveis","hipertensos"],avoid:[],temp:"95°C",tempo:"10 min",dose:"Pomada: aplicação tópica conforme bula",freq:"2-3x ao dia em área afetada",tags:["inflamacao","pele"],momento:["qualquer"]},
  {id:37,n:"Erva-Baleeira",lat:"Cordia verbenacea DC.",icon:"🌿",cat:"Anti-inflamatório",linha:"Funcional",tagline:"Do litoral atlântico ao primeiro fitoterápico brasileiro patenteado (Acheflan).",ef:"Anti-inflamatório tópico — monografado, Analgésico local, Antimicrobiano tópico",detail:"Planta caiçara do litoral atlântico. Primeiro fitoterápico brasileiro com pesquisa clínica completa (Acheflan). Anti-inflamatório tópico via alfa-humuleno e trans-cariofileno.",safe:["adultos saudáveis","hipertensos"],avoid:[],temp:"95°C",tempo:"10 min",dose:"3 g de folhas / 150 ml (uso externo)",freq:"compressa 3x ao dia",tags:["inflamacao"],momento:["qualquer"]},
  {id:38,n:"Erva-de-Bicho",lat:"Polygonum punctatum Elliot",icon:"🌿",cat:"Anti-inflamatório",linha:"Funcional",tagline:"Pimenteira-d'água das várzeas brasileiras — anti-hemorroidal oficial.",ef:"Anti-hemorroidal — monografado, Adstringente (taninos), Hemostático local",detail:"Planta de várzeas brasileiras com sabor picante (polygodial). Anti-hemorroidal monografado — banho de assento. Taninos adstringentes mais leve irritação local produzem efeito contração-cicatrização.",safe:["adultos saudáveis","hipertensos"],avoid:["gestantes","lactantes"],temp:"95°C",tempo:"10 min",dose:"3 g de partes aéreas / 150 ml (uso externo)",freq:"banho de assento 3x ao dia",tags:["hemorroidas"],momento:["qualquer"]},
  {id:39,n:"Erva-Mate",lat:"Ilex paraguariensis A.St.-Hil.",icon:"🧉",cat:"Estimulante",linha:"Essencial",tagline:"Chimarrão, tererê e chá-mate — estímulo brasileiro por excelência.",ef:"Estimulante, Antioxidante, Termogênico, Diurético leve",detail:"Xantinas (cafeína mais teobromina) e polifenóis. Ritual comunitário do Sul. Consumo muito quente associado a câncer de esôfago (IARC 2A) — evitar acima de 70°C.",safe:["hipertensos (moderado)"],avoid:["gestantes","insônia","crianças","após 16h"],temp:"70°C",tempo:"4 min",dose:"1 col. sopa / 200ml",freq:"manhã-tarde",tags:["energia","foco","termogênico","antioxidante","tradição"],momento:["manha","tarde"]},
  {id:40,n:"Guaçatonga",lat:"Casearia sylvestris Sw.",icon:"🌿",cat:"Digestivo",linha:"Essencial",tagline:"Erva-de-bugre da Mata Atlântica — antiulcerosa nativa brasileira.",ef:"Antidispéptico — monografado, Antiulcerogênico, Anti-inflamatório",detail:"Irmã menos famosa da espinheira-santa — antidispéptico e antiulcerogênico monografado. Casearinas (diterpenos clerodanos) com atividade antitumoral em estudos de bancada.",safe:["adultos saudáveis","hipertensos"],avoid:["gestantes","lactantes","crianças"],temp:"95°C",tempo:"5 min",dose:"2 a 4 g de folhas / 150 ml",freq:"2-3x ao dia antes das refeições",tags:["digestao","inflamacao","oral"],momento:["qualquer"]},
  {id:41,n:"Macela",lat:"Achyrocline satureioides (Lam.) DC.",icon:"🌿",cat:"Digestivo",linha:"Essencial",tagline:"Flor amarela do pampa — tradição gaúcha de colher na Sexta-Feira Santa.",ef:"Antidispéptico — monografado, Antiespasmódico digestivo, Anti-inflamatório",detail:"Flor amarela do pampa, tradição gaúcha colher na Sexta-Feira Santa. Antidispéptico monografado — flavonoides com ação antiespasmódica e ansiolítica leve. Travesseiros aromáticos do Sul.",safe:["adultos saudáveis","hipertensos"],avoid:["gestantes","crianças"],temp:"95°C",tempo:"5 min",dose:"1,5 g de sumidades floridas / 150 ml",freq:"2-3x ao dia após refeições",tags:["digestao","inflamacao","antiespasmodico"],momento:["noite"]},
  {id:42,n:"Quebra-Pedra",lat:"Phyllanthus niruri L.",icon:"🌿",cat:"Urinário",linha:"Funcional",tagline:"A erva que dissolve cálculos renais — litolítico oficial da Anvisa.",ef:"Litolítico — monografado, Diurético leve, Anti-inflamatório",detail:"Erva rasteira que reduz formação de cristais urinários. Litolítico monografado pela Anvisa — lignanas (filantina, hipofilantina) previnem nucleação de oxalato de cálcio. Manter hidratação.",safe:["adultos saudáveis","hipertensos"],avoid:["gestantes"],temp:"95°C",tempo:"10 min",dose:"3 g de partes aéreas / 150 ml",freq:"2-3x ao dia",tags:["urinario"],momento:["qualquer"]},
];
